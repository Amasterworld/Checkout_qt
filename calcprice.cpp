...
void CalcPrice::AddItemPrice(std::string_view item, double price) {

    prices[item] = price;
}

void CalcPrice::AddItems(std::string_view item, int nums_of_items) {
...
void CalcPrice::AddDisCount(std::string_view item, int num_of_items, int percentage_discount) {
...
double CalcPrice::CalcTotalOfDiscountItems()  {
